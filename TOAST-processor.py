...
# step through timestamps/images, stepg through each chunk and put all "good" abstich values into dataframe
tsList = list(results)
...
for ts in meas.index:
    ...
    if prev is not None:
        ...
        res = this[0] # Oh Oh: for the first image in series the Abstich is just chosen by order
        keep = res
